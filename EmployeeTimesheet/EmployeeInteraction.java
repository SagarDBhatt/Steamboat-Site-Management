...
public class EmployeeInteraction {
	...
	public static void insertEmployeeData(String empName, Double workHours, JDateChooser dateChooser) {
		...
		try {
			...
			e.printStackTrace();
			JOptionPane.showMessageDialog(null, "Unable to update data into Employee Table!", "Error!!",
					JOptionPane.ERROR_MESSAGE);
		}
		catch (NumberFormatException e) {
			e.printStackTrace();JOptionPane.showMessageDialog(null, "Please insert valid value!", "Error!!",
					JOptionPane.ERROR_MESSAGE);
		}
